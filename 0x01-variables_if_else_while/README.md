...
This directory contains files that are solutions to tasks covering concepts on arithmetic, logical, relational, and boolean operators in C. Variable declaration of type char, int, and unsigned int data type  using if and if...else statements, and implementing while loops.
