THIS DIRECTORY CONTAINS FILES WIHT CODES INTENDED TO SOLVE MY ALX TASKS ON 0x02. C - Functions, nested loops.

In this project, I covered concepts on nested loops, header files, and variable scope in C while practicing declaring and defining my own functions.
