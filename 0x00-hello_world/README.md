In this project I was required to carry out tasks which covered concepts on compilation using gcc, preprocessing, linking, entry points in Cusing 'main' and text-printing functions in C.
